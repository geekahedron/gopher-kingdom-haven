...
function insertGopherBox() {
    ...
    addGlobalStyle(".gkh-section { border: 1px solid #3B4041}");
    ...
    var spelltitle = document.createElement("h3");
    spelltitle.id = "spelltitle";
    spelltitle.classList.add("gkh-sectiontitle");
    var spellbox = document.createElement("div");
    spellbox.id = "spellbox";
    spellbox.classList.add("gkh-section");
    var newstitle = document.createElement("h3");
    newstitle.id = "spelltitle";
    newstitle.classList.add("gkh-sectiontitle");
    var newsbox = document.createElement("div");
    newsbox.id = "newsbox";
    newsbox.classList.add("gkh-section");
    gopherbox.appendChild(pagetitle);
    gopherbox.appendChild(spelltitle);
    gopherbox.appendChild(spellbox);
    gopherbox.appendChild(newstitle);
